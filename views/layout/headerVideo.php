...
<html lang="es">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= root ?>assets/plugins/WaitMe/waitMe.min.css">
    ...
    <body class="bg-light">
        <div class="video">
            ...
            <div id="InfoVideo">
                <div class="titulo">
                    <img src="assets/img/logoazul.png">
                    <p>Todo para tu negocio</p>
                </div>
            </div>
        </div>
        <div class="content">
            <header class="row ">
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light clearfix barra">
                        <div class="container">
                            <a class="navbar-brand" href="#">
                                <img src="<?= root ?>assets/img/logoazul.png" alt="Logo Servinox" style="max-width: 60%;" class="lightSpeedIn">
                            </a>
